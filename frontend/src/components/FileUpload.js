  ...
  return (
    <div className="file-upload-container">
      <div
        className="drop-zone"
        style={{
          borderColor: dragging ? 'var(--electric)' : undefined,
          background: dragging ? 'var(--electric-dim)' : undefined,
        }}
        onDrop={handleDrop}
      ...
      >
        ...
        <input ref={inputRef} type="file" accept=".csv" onChange={handleFileChange} className="file-input" />
      </div>
      ...
      {file && (
        <div className="file-selected">
          ...
          {uploaded && <span style={{ color: 'var(--green)', fontSize: '0.8rem', fontWeight: 600 }}>✓ Uploaded</span>}
        </div>
      )}
