...
function App() {
  ...
  const handleUploadSuccess = (file) => { setFileUploaded(true); setUploadedFile(file); };
  ...
  const handleGoBack = () => { setChartData(null); setFileUploaded(false); setUploadedFile(null); };
  ...
  return (
    <div className="app-container">
      ...
      <nav className="navbar">
        <div className="navbar-logo" onClick={handleGoBack}>SentimentScope</div>
          ...
          {user ? (
            ...
            <li>
              <button
                ...
                style={authMode === 'signup' ? { background: 'transparent', color: 'var(--electric)', border: '1px solid var(--border)' } : {}}
              >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            ...
            <div className="auth-auth-container">
              ...
              <div className="toggle-auth">
                ...
                <button className="toggle-button" onClick={() => { setAuthMode(authMode === 'login' ? 'signup' : 'login'); setAuthError(''); }}>
          ...
          <>
            ...
            {!chartData && !loading && (
              <div className="file-upload-wrapper">
                <div className="file-upload-header">
                  ...
                  <p>
                    Upload a CSV file with <code style={{ color: 'var(--electric)', fontSize: '0.875rem', background: 'var(--electric-dim)', padding: '2px 7px', borderRadius: '5px' }}>id, text, timestamp</code> columns
                    <br />and get instant sentiment insights.
                  </p>
                </div>
                <FileUpload
            ...
            {chartData && !loading && (
              <div className="dashboard-container">
                <button className="back-button" onClick={handleGoBack}>← New analysis</button>
                ...
                {(() => {
                  ...
                  const avgConf = total > 0 ? Math.round((chartData.reduce((a, b) => a + b.confidence, 0) / total) * 100) : 0;
                  return (
